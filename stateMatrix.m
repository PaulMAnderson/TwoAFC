...
CenterPortLED = strcat('PWM',num2str(LeftPort));
RightPortLED  = strcat('PWM',num2str(LeftPort));
...
sma = AddState(sma, 'Name', 'rewarded_Rin_grace',... %NEW STATE
    ...
    'StateChangeConditions',{'Tup','timeOut_SkippedFeedback',RightPortIn,'rewarded_Rin','GlobalTimer1_End','timeOut_SkippedFeedback',CenterPortIn,'timeOut_SkippedFeedback',LeftPortIn,'timeOut_SkippedFeedback'},...
    'OutputActions', {});

sma = AddState(sma, 'Name', 'rewarded_Lin_grace',... %NEW STATE
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','timeOut_SkippedFeedback',LeftPortIn,'rewarded_Lin','GlobalTimer1_End','timeOut_SkippedFeedback',CenterPortIn,'timeOut_SkippedFeedback',RightPortIn,'timeOut_SkippedFeedback'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'unrewarded_Lin_grace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','timeOut_IncorrectChoice',LeftPortIn,'unrewarded_Lin','GlobalTimer2_End','timeOut_IncorrectChoice',CenterPortIn,'timeOut_IncorrectChoice',RightPortIn,'timeOut_IncorrectChoice'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'unrewarded_Rin_grace',...
    'Timer', TaskParameters.GUI.FeedbackDelayGrace,...
    'StateChangeConditions',{'Tup','timeOut_IncorrectChoice',RightPortIn,'unrewarded_Rin','GlobalTimer2_End','timeOut_IncorrectChoice',CenterPortIn,'timeOut_IncorrectChoice',LeftPortIn,'timeOut_IncorrectChoice'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'timeOut_BrokeFixation',...
    ...
    'OutputActions',{'SoftCode',11,'WireState',0,'BNCState',0});
...
sma = AddState(sma, 'Name', 'timeOut_IncorrectChoice',...
    ...
    'StateChangeConditions',{'Tup','ITI'},...
    'OutputActions',{'SoftCode',12,'WireState',0,'BNCState',0});

% Skipped feedback used to trigger a 'beep' but that should only 
...
sma = AddState(sma, 'Name', 'ITI',...
    ...
    'OutputActions',{'WireState',0,'BNCState',0}); % Sets flow rates for next trial
