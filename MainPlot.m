...
switch Action
    case 'init'
        ...
        BpodSystem.GUIHandles.OutcomePlot.percCorrL = text(12,0.2,'CorrL:',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');
        BpodSystem.GUIHandles.OutcomePlot.percCorrR = text(12,0.1,'CorrR:',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');              
        %%%% END (03.08.23)
        
        BpodSystem.GUIHandles.OutcomePlot.FeedbackDelay = text(12,-0.1,'Curr delay:',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');    
        BpodSystem.GUIHandles.OutcomePlot.currTr = text(12,-0.2,'Curr trial:',...
            'verticalalignment','bottom',...
            'horizontalalignment','right');    
